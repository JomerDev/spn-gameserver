...
class Environment
{
	public:
		...
		static constexpr const char* ENV_MYSQL_USER_DEFAULT = "spn";

		static constexpr const char* ENV_MYSQL_PASSWORD = "MYSQL_PASSWORD";
		static constexpr const char* ENV_MYSQL_PASSWORD_DEFAULT = "spn";

		static constexpr const char* ENV_MYSQL_DB = "MYSQL_DB";
		static constexpr const char* ENV_MYSQL_DB_DEFAULT = "spn";
